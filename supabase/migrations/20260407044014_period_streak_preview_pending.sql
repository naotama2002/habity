-- Add preview pending support for weekly/monthly streaks.
-- When p_preview_pending=TRUE and the current period hasn't met the goal yet,
-- skip it and check the previous period for an ongoing streak.
