...
- 習慣カードをクリック → 詳細画面へ
- [+] ボタン → 新規習慣作成
- 日付ストリップをタップ → 過去7日・今日・明日を切り替え
- Today/明日で未記録の習慣は、直近の継続中ストリークを薄表示する
- Today でチェックイン済み、または skip 済みならストリークは通常表示する
